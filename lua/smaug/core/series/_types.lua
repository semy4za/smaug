...
return function(I)
    ...
    local DTYPES = {
        ...
        int64 = {
            ...
            add_checked = C.smaug_i64_add_checked_series,
            sub_checked = C.smaug_i64_sub_checked_series,
            mul_checked = C.smaug_i64_mul_checked_series,
            div_checked = C.smaug_i64_div_checked_series,
            ...
            add_scalar_checked = C.smaug_i64_add_scalar_checked,
            sub_scalar_checked = C.smaug_i64_sub_scalar_checked,
            mul_scalar_checked = C.smaug_i64_mul_scalar_checked,
            div_scalar_checked = C.smaug_i64_div_scalar_checked,
            sum = C.smaug_i64_sum, sum_checked = C.smaug_i64_sum_checked,
            mean = C.smaug_i64_mean,
            ...
            cumsum_checked  = C.smaug_i64_cumsum_checked,
            cumprod_checked = C.smaug_i64_cumprod_checked,
            cummin  = C.smaug_i64_cummin,
            cummax  = C.smaug_i64_cummax,
            diff    = C.smaug_i64_diff,
            diff_checked = C.smaug_i64_diff_checked,
            ...
            rolling_sum_checked = C.smaug_i64_rolling_sum_checked,
