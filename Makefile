...
SRCS = src/smaug_core.c src/smaug_ops_f64.c src/smaug_ops_i64.c src/smaug_ops_bool.c src/smaug_str.c src/smaug_ops_str.c
...
C_TESTS_PLAIN = test_alloc test_ops test_ops_edge test_bool test_string
