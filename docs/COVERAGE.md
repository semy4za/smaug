...
- Commit medido: `ebb8e8d`  |  Data: 2026-06-14 13:44:16 -0300
...
- **Branch-bruto** (todos os ramos): `2256/2630 = 85.78%` -- 90 ramo(s) excluido(s) com justificativa (ver fim do arquivo).
...
| **TOTAL** | `2224/2293 = 96.99%` `[█████████░]` | `2256/2540 = 88.82%` `[████████░░]` |
