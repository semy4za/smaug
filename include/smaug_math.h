...
// Append dinâmico
int smaug_i64_append(smaug_series_i64_t *s, int64_t val); /* Retorna 0 success, -1 fail */
...
double smaug_i64_std(const smaug_series_i64_t *s, bool ignore_na); /* Population std */
double smaug_i64_var(const smaug_series_i64_t *s, bool ignore_na); /* Population var */
