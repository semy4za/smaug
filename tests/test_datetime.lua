-- tests/test_datetime.lua
-- Testes Lua do dtype datetime: factories, from_table, accessor .dt,
-- truncate, diff, add_*, comparações, sort, filter, integração DataSet.
-- Roda da raiz: luajit tests/test_datetime.lua
...
print(string.format(
    "OK — %d checks passaram (datetime: factories, .dt, truncate, diff, add_*, " ..
    "comparações, sort, filter, astype, DataSet)",
    n_ok))
