-- tests/test_special.lua
-- Valores especiais do f64 (Fase 1.6 — endurecimento).
-- Codifica o "Contrato de valores especiais" (ver Roadmap):
--   * NaN é distinto de null (nunca se converte um no outro)
--   * NaN é forte/contagioso; comparações com NaN dão false
...
print(string.format("OK — %d checks passaram (valores especiais f64)", n_ok))
