-- tests/test_access.lua
-- Bloco F.5 — acesso e ergonomia.
--   Series: at / iat (indexação e chamada)
--   DataSet: at / iat (célula), insert, to_dict, from_dict, to_markdown, to_string
--
-- Roda da raiz: luajit tests/test_access.lua
...
print(string.format(
    "OK — %d checks passaram (F.5 acesso: Series at/iat, DataSet at/iat/insert/" ..
    "to_dict/from_dict/to_markdown/to_string)",
    n_ok))
