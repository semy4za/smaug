...
--   Series: corr, cov, autocorr, dot, pct_change
--   DataSet: corr, cov (matriz N×N)
--
-- Valores de referência calculados à mão (ver comentários).
...
print(string.format(
    "OK — %d checks passaram (F.1 estatístico: Series corr/cov/autocorr/dot/" ..
    "pct_change + DataSet corr/cov matriz N×N)",
    n_ok))
